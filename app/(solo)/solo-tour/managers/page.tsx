...
function generateStarRating(rating: any) {
    ...
    for (let i = 1; i <= 5; i++) {
        if (i === 3 && rating >= 6) {
            stars.push(<i key={i} className="fas fa-sun" style={{ color: 'gold' }}></i>);
        } else if (i <= rating) {
        ...
        <div className="portal-root-wrapper">
            ...
            <div className="portal-container">
                ...
                <header className="portal-header">
                    ...
                    <div className="onedrive-link" style={{ marginTop: '1rem' }}>
                        <a 
                        ...
                        >
                            <i className="fas fa-table"></i> View Manager Data Ledger
                        </a>
                    </div>
                </header>
                ...
                <div className="search-container">
                    <div className="search-box">
                        ...
                        {searchTerm && (
                            <i 
                                className="fas fa-times search-clear visible" 
                                onClick={() => setSearchTerm('')}
                                style={{ cursor: 'pointer', right: '1.25rem', position: 'absolute', opacity: 0.7 }}
                            ></i>
                        )}
                    </div>
                </div>
                ...
                <div className="managers-container">
                    {loading ? (
                            ...
                            <div key={i} className="manager-card skeleton">
                                <div className="skeleton-header">
                                    ...
                                    <div className="skeleton-info">
                                        ...
                                        <div className="skeleton-club"></div>
                        ...
                        <div className="no-results-message">
                            ...
                            <p>No tacticians match your search term "{searchTerm}"</p>
                            ...
                            <div key={i} className="manager-card active">
                                ...
                                >
                                    ...
                                    <div className="manager-info">
                                        ...
                                        <p className="manager-club">{manager.club}</p>
                                ...
                                <div className="manager-stats">
                                    <div className="stat-group">
                                        <span className="stat-label"><i className="fas fa-sort-numeric-up"></i>Rank</span>
                                        <span className="stat-value">{manager.age}</span>
                                    </div>
                                    <div className="stat-group">
                                        <span className="stat-label"><i className="fas fa-star"></i>Overall</span>
                                        <span className="stat-value">{manager.overall_rating}</span>
                                    </div>
                                    <div className="stat-group">
                                        <span className="stat-label"><i className="fas fa-coins"></i>Club Value</span>
                                        <span className="stat-value">{manager.club_total_value}M</span>
                                    </div>
                                    <div className="stat-group">
                                        <span className="stat-label"><i className="fas fa-trophy"></i>Trophies</span>
                                        <span className="stat-value">{manager.trophies + manager.awards}</span>
                                    </div>
                                </div>
                                <div className="manager-footer">
                                    <Link href={`/solo-tour/managers/${encodeURIComponent(manager.name)}`} className="view-profile">
                                        View Profile
                                    </Link>
                                </div>
                            </div>
                ...
                <footer className="portal-footer">
                    <div className="portal-status-bar">
                        ...
                        <div className="status-item">
                            Total Tacticians: {managers.length}
                        </div>
                    </div>
